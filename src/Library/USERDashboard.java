...
public class USERDashboard extends javax.swing.JFrame {
    ...
    public USERDashboard(Account user) {
        currentAccount = user;
        initComponents();
    }
        ...
        try{
           ...
           System.out.println("File exists.");
            ...
            try {
                ...
                Logger.getLogger(USERDashboard.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new USERDashboard(currentAccount).setVisible(true);
            }
        });
    }
